    ...
    <body class="skin-light" onload="loadAmountCart()">
        <jsp:include page="Menu.jsp"></jsp:include>
            ...
            <div class="card-group" style="margin-top:50px;">
                <div class="card" style="border-style: none;">
                    <img style="height:55px; width:64px; margin: auto;" src="https://cdn0.iconfinder.com/data/icons/logistic-icons-rounded/110/Truck-512.png">
                    <div class="card-body">
                ...
                <div class="card" style="border-style: none;">
                    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://th.bing.com/th/id/OIP.7USKWmA_28rAc8n4W9TuywHaHa?rs=1&pid=ImgDetMain" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card" style="border-style: none;">
                    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://th.bing.com/th/id/R.aefdffa32ffeedb5074e9c68b4dc8bf8?rik=qYSfXw4cDR%2bxxw&pid=ImgRaw&r=0" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card" style="border-style: none;">
                    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://cdn0.iconfinder.com/data/icons/simple-icons-4/512/refresh.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="row" style="margin-top:50px">            
                <div class="col-sm-12">
                    <div id="content" class="row">
                        ...
                        <div class=" col-12 col-md-12 col-lg-6">
                            <img class="card-img-top" src="https://th.bing.com/th/id/OIP.2pKZEBMA32muy0fKoAVfRwHaFj?w=302&h=181&c=7&r=0&o=5&pid=1.7" alt="Card image cap">        
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
                        ...
                        function loadAmountCart() {
                            $.ajax({
                                url: "/LapTrinhWeb/loadAllAmountCart",
                                type: "get", //send it through get method
                                data: {
