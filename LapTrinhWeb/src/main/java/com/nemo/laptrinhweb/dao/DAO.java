 ...
 */
package com.nemo.laptrinhweb.dao;

import com.nemo.laptrinhweb.context.DBContext;
...
import com.nemo.laptrinhweb.entity.Supplier;
...
//      double sum = dao.sumAllInvoice();
//        System.out.println(sum);
//      System.out.println("da chay xong");
        List<Category> listC = dao.getAllCategory();
        System.out.println(listC);
//        List<Account> cat = dao.getAllAccount();
